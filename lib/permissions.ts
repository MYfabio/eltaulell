export const PERMISSIONS = {
  ...
  CREATE_ATTACHMENT: "board:attachment:create",
  DELETE_ATTACHMENT: "board:attachment:delete",
  CREATE_POLL: "poll:create",
  VOTE_POLL: "poll:vote",
  MANAGE_POLL_RESULTS: "poll:results:manage",
...
export const ROLE_PERMISSIONS: Record<AppRole, readonly Permission[]> = {
  COORDINATOR: [
    ...
    PERMISSIONS.MANAGE_POLL_RESULTS,
...
export const PERMISSION_LABELS: Record<Permission, string> = {
  ...
  [PERMISSIONS.CREATE_ATTACHMENT]: "Adjuntar imatges i PDF",
  [PERMISSIONS.DELETE_ATTACHMENT]: "Eliminar fitxers del tauler",
  [PERMISSIONS.CREATE_POLL]: "Crear consultes",
  [PERMISSIONS.VOTE_POLL]: "Participar en consultes",
  [PERMISSIONS.MANAGE_POLL_RESULTS]: "Validar i publicar resultats",
